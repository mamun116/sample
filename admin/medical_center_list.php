            ...
            <tbody>
                ...
                <?php while ($row = mysql_fetch_array($all_data)) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="update_medical_center.php?id=<?php echo $row['id'];?>"><i class="fa fa-edit"></i></a>
                            <a href="delete_medical_center.php?id=<?php echo $row['id'];?>"><i class="fa fa-trash-o"></i></a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
